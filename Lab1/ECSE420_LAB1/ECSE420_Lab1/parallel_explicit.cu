...
int main(int argc, char* argv[])
{
	...
	float data_copy_time, sim_time, total_copy_time, total_time;
	GpuTimer timer{};
	...
	timer.Stop();
	total_time = total_copy_time = data_copy_time = timer.Elapsed();
	printf("Copying input data from host mem to device mem took %f milliseconds (or %f seconds).\n", data_copy_time,
		data_copy_time / 1000);
	...
	total_time += sim_time;
	printf("Simulation done. It took %f milliseconds (or %f seconds).\n", sim_time, sim_time / 1000);
	...
	total_time += data_copy_time;
	total_copy_time += data_copy_time;
	printf("Copying output data from device mem to host mem took %f milliseconds (or %f seconds).\n", data_copy_time,
		data_copy_time / 1000);
